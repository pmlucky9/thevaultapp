...
namespace TheVaultApp\Magento2\Model\Adapter;
...
class ChargeAmountAdapter {
    ...
    public static function getPaymentFinalCurrencyCode($orderCurrencyCode) {
        ...
        $gatewayPaymentCurrency = $manager->create('TheVaultApp\Magento2\Gateway\Config\Config')->getPaymentCurrency();
        ...
        elseif ($gatewayPaymentCurrency == self::ORDER_CURRENCY) {
            ...
            $finalCurrencyCode = $manager->create('TheVaultApp\Magento2\Gateway\Config\Config')->getCustomCurrency();
        }
