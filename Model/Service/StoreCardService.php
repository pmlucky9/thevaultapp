...
class StoreCardService {
    ...
    private function authorizeTransaction() {
        ...
        $transfer = $this->transferFactory->create([
            ...
            'value'         => (float) $this->scopeConfig->getValue('payment/thevaultapp/save_card_check_amount') * 100,
            'currency'      => $this->scopeConfig->getValue('payment/thevaultapp/save_card_check_currency'),
