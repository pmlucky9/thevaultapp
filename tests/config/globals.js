  ...
  selector: {
    frontend: {
      order: {
        ...
        checkout_payment_option: '#thevaultapp',
      ...
      checkout_option_title: 'div.payment-method:nth-child(3) > div:nth-child(1) > label:nth-child(2) > span:nth-child(1)',
    },
    backend: {
      ...
      plugin: {
        selector: '#payment_us_thevaultapp-head',
        save: 'button.action-default',
        basic_category: {
          selector: '#payment_us_thevaultapp_thevaultapp_base_settings-head',
          environment: '#payment_us_thevaultapp_thevaultapp_base_settings_environment',
          title: '#payment_us_thevaultapp_thevaultapp_base_settings_title',
          sort_order: '#payment_us_thevaultapp_thevaultapp_base_settings_sort_order',
          new_order_status: '#payment_us_thevaultapp_thevaultapp_base_settings_new_order_status',
          auto_invoices: '#payment_us_thevaultapp_thevaultapp_base_settings_auto_generate_invoice',
          integration: '#payment_us_thevaultapp_thevaultapp_base_settings_integration',
          theme: '#payment_us_thevaultapp_thevaultapp_base_settings_embedded_theme',
          css_file: '#payment_us_thevaultapp_thevaultapp_base_settings_css_file',
          hosted_theme_color: '#payment_us_thevaultapp_thevaultapp_base_settings_theme_color',
          hosted_payment_mode: '#payment_us_thevaultapp_thevaultapp_base_settings_payment_mode',
          hosted_button_label: '#payment_us_thevaultapp_thevaultapp_base_settings_button_label',
          hosted_header: '#modal-wrapper > div.cko-md-content > div > div.header',
          hosted_pay_button: '#modal-wrapper > div.cko-md-content > div > div.container-body > div.content.card > form > input',
        ...
        advanced_category: {
          selector: '#payment_us_thevaultapp_thevaultapp_advanced_settings-head',
          cvv_vetification: '#payment_us_thevaultapp_thevaultapp_advanced_settings_useccv',
          vault: '#payment_us_thevaultapp_thevaultapp_advanced_settings_thevaultapp_cc_vault_active',
          save_cards_authomatically: '#payment_us_thevaultapp_thevaultapp_advanced_settings_thevaultapp_cc_vault_autosave',
          hide_card_storage: '#payment_us_thevaultapp_thevaultapp_advanced_settings_thevaultapp_cc_vault_hide_storage',
          vaut_title: '#payment_us_thevaultapp_thevaultapp_advanced_settings_thevaultapp_cc_vault_title',
          three_d: '#payment_us_thevaultapp_thevaultapp_advanced_settings_verify_3dsecure',
          autocapture: '#payment_us_thevaultapp_thevaultapp_advanced_settings_auto_capture',
          autocap_time: '#payment_us_thevaultapp_thevaultapp_advanced_settings_auto_capture_time',
        },
        order_category: {
          selector: '#payment_us_thevaultapp_thevaultapp_order_settings-head',
          order_creation: '#payment_us_thevaultapp_thevaultapp_order_settings_order_creation',
          order_comments: '#payment_us_thevaultapp_thevaultapp_order_settings_order_comments_override',
          new_order_status: '#payment_us_thevaultapp_thevaultapp_order_settings_new_order_status',
          authorised_order_status: '#payment_us_thevaultapp_thevaultapp_order_settings_order_status_authorized',
          captured_order_status: '#payment_us_thevaultapp_thevaultapp_order_settings_order_status_captured',
          refund_order_status: '#payment_us_thevaultapp_thevaultapp_order_settings_order_status_refunded',
          flagged_order_status: '#payment_us_thevaultapp_thevaultapp_order_settings_order_status_flagged',
          auto_generated_invoice: '#payment_us_thevaultapp_thevaultapp_order_settings_auto_generate_invoice',
        },
        keys_category: {
          selector: '#payment_us_thevaultapp_thevaultapp_account_keys-head',
          public: '#payment_us_thevaultapp_thevaultapp_account_keys_public_key',
          secret: '#payment_us_thevaultapp_thevaultapp_account_keys_secret_key',
          private_shared: '#payment_us_thevaultapp_thevaultapp_account_keys_private_shared_key',
        },
      },
