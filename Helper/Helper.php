...
namespace TheVaultApp\Magento2\Helper;
...
class Helper {
    ...
    public function getModuleVersion() {
        // Get the module path
        $module_path = $this->directoryReader->getModuleDir('', 'TheVaultApp_Magento2');
    ...
    public function isMadaBin($bin) {
        // Set the root path
        $csvPath = $this->directoryReader->getModuleDir('', 'TheVaultApp_Magento2')  . '/' . $this->config->getMadaBinsPath();
